    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-green-50 to-emerald-50 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center space-y-2">
          <div className="inline-flex items-center justify-center w-15 h-15 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl mb-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {informationPages.map((page) => (
              ...
              >
                <div className="card hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] border-l-4 border-green-500 h-full">
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-grow">
                      <h2 className="text-xl font-bold text-gray-900 group-hover:text-green-600 transition-colors mb-3">
                        {page.title}
                      </h2>
                    ...
                    {/* Read More Link */}
                    <div className="flex items-center text-green-600 font-semibold group-hover:translate-x-2 transition-transform mt-auto">
