          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#050E3C] mb-1">
                INDX1000 – {config.displayName} <span className="font-normal">(bêta v1.0)</span>
              </h1>
              <p className="text-md text-gray-700">
                {config.sequences} – {config.duration}.
              </p>
            </div>
            ...
            <div className="space-y-4 text-md text-gray-900 leading-relaxed">
              ...
              <p>
                Vous allez débuter une session INDX1000 - {config.displayName}
              </p>
              ...
              <div className="mt-6">
                ...
                <div className="space-y-3 text-gray-900">
                  <p>Cette série ne peut être validée que si et seulement si chaque séquence a reçu une réponse dans le temps total imparti ({config.duration}).</p>
